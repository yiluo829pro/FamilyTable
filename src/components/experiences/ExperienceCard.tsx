  ...
  return (
    <>
      <div className="card hover:shadow-md transition-shadow group">
        <div className="h-52 bg-gradient-to-br from-emerald-50 to-teal-100 flex items-center justify-center rounded-t-2xl overflow-hidden">
        ...
        <div className="p-3">
          <div className="flex items-center justify-between gap-2">
            <h3 className="font-heading text-sm font-semibold text-forest group-hover:text-forest-light transition-colors line-clamp-1">
              {experience.name}
            </h3>
